    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('databases', fractal_database.fields.LocalManyToManyField(related_name='gateways', to='fractal_database.database')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forward_port', models.CharField(blank=True, max_length=5, null=True)),
                ('domain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='domains', to='gateway.domain')),
                ('service_config', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='links', to='fractal_database.serviceinstanceconfig')),
            ],
            options={
                'abstract': False,
            },
